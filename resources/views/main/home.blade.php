...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/amazeui/css/amazeui.min.css')}}">
    <link rel="stylesheet" href="{{ asset('/amazeui/css/wap.css?2')}}">
    <title>首页</title>
</head>
<body>
...
<div class="pet_mian" id="top">
  ...
  <ul class="am-slides">
      <li>
            <img src="{{ asset('/amazeui/img/fl01.png')}}">
      ...
      <li>
            <img src="{{ asset('/amazeui/img/fl02.png')}}">
            <div class="pet_slider_font">
      ...
      <li>
            <img src="{{ asset('/amazeui/img/fl03.png')}}">
            <div class="pet_slider_font">
...
<div class="pet_content_main">
      ...
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        ...
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
          ...
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/q1.jpg')}}" class="pet_list_one_img" alt=""/>
            </a>
          </div>
      </li>
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        ...
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
          ...
          <div class="am-u-sm-4 am-list-thumb pet_video_info">
            ...
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/q4.jpg')}}" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
            </a>
          </div>
      </li>
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        ...
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
          ...
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/q5.jpg')}}" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
            </a>
          </div>
      </li>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list" >
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/qq1.jpg')}}"  alt="某天 也许会相遇 相遇在这个好地方"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/qq2.jpg')}}"  alt="不要太担心 只因为我相信"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/qq3.jpg')}}"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
  </ul>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list pet_list_one_tytj" >
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/w1.jpg')}}"  alt="某天 也许会相遇 相遇在这个好地方"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/w2.jpg')}}"  alt="不要太担心 只因为我相信"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/w3.jpg')}}"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
       <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/w4.jpg')}}"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
       <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/w5.jpg')}}"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
       <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="{{ asset('/amazeui/img/w6.jpg')}}"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
  </ul>
      ...
      <li class="am-g am-list-item-desced pet_list_one_block">
           <div class="pet_article_user_block">
             ...
             <img src="{{ asset('/amazeui/img/c2.png')}}" alt=""></div>
...
<script src="{{ asset('/amazeui/js/amazeui.min.js')}}"></script>
<script>
$(function(){
